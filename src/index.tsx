...
const ReactApp = () => {
  ...
  return (
    <StrictMode>
      <SEO
        title="BoxBit Blockchain - Decentralized Blockchain Application"
        description="BoxBit Blockchain is DeFi’s first Dynamic Market Maker; a decentralized exchange protocol that provides frictionless crypto liquidity with extremely high flexibility and capital efficiency."
      />
      <FixedGlobalStyle />
